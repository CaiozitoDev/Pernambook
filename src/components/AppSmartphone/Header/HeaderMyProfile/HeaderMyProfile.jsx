...
function HeaderMyProfile() {
    ...
    return (
        <div className='HeaderMyProfile' onClick={() => {document.querySelector('.Left').classList.add('isLeftClicked'); document.querySelector('.LeftMenu').classList.add('isLeftMenuClicked')}}>
